...
**"Tool use"** implies a passive instrument. Tools don't have latent structure you can probe.
...
We use "dialogue" as a functional metaphor to describe the *phenomenology* of the interface: the back-and-forth exchange creates an *experience* of conversation through prediction and pattern matching. The human experiences this as dialogue; the system executes token prediction with attention mechanisms.
...
**Citation:**
> *This brief was developed through Generative Productive Dialogue between [Attorney Name] and Claude Sonnet 4, requiring human verification of all case citations and legal reasoning.*

### Example 2: Technical Documentation

**Process:**
- Engineer provides architecture decisions, API specifications, deployment constraints
- System generates documentation structure and initial content
- Engineer corrects technical errors, adds institutional knowledge, verifies all code examples
- 15 exchanges over 90 minutes
- Final output: Engineer responsible for technical accuracy

**Citation:**
> *Documentation produced via GPD. All code examples tested and verified by engineering team.*

### Example 3: Research Analysis

**Process:**
- Researcher provides data sets, theoretical framework, research questions
- System generates statistical analysis, identifies patterns, suggests interpretations
- Researcher verifies calculations, challenges interpretations, adds domain expertise
- 31 exchanges over 4 hours
- Final paper: Researcher accountable for all claims and conclusions

**Citation:**
> *Analysis conducted through Generative Productive Dialogue. All statistical claims verified independently by research team.*

### Example 4: This Framework Document

**Process:**
- Human identified vocabulary gap, proposed initial structure
...
**Citation:**
> *This document was developed through Generative Productive Dialogue—a process interfacing human and computational reasoning to generate artifacts.*
...
- **Medical diagnosis or treatment plans** - Human medical professional must own all decisions
- **Legal advice to clients** - Attorney maintains professional responsibility regardless of process
- **Financial advice** - Advisor legally accountable for recommendations
- **Safety-critical systems** - Engineering sign-off required on all outputs

### Contexts Requiring Verification GPD Cannot Provide
- **Academic papers with citations** - Human must verify every citation independently (systems hallucinate sources)
- **Mathematical proofs** - System can produce plausible-looking but invalid proofs
- **Historical claims** - System may confabulate dates, events, causation
- **Current events post-training cutoff** - System has no knowledge of recent developments
...
- **Regulatory compliance** - Where process documentation is required and GPD creates attribution ambiguity
...
- System generates plausible-sounding but false information
...
- System may contradict itself across exchanges
- No memory between sessions (unless explicitly provided)
- May forget constraints stated earlier in same conversation
- **Human responsibility:** Track consistency, re-state critical constraints

**Bias Amplification**
- System may reproduce or amplify biases from training data
- Subtle patterns in word choice, framing, examples
...
- Unclear who is accountable for which parts of output
- "We decided" language obscuring human responsibility
...
- Review by licensed attorney in relevant jurisdiction
...
- Plagiarism check of generated text
...
- Citations without DOI or verifiable URL
- Statistical claims without methodology
- "Studies show" without specific study reference
...
- Professional work where process transparency expected
...
**Minimal:**
> *Developed using Generative Productive Dialogue*

**Standard:**
> *This document was developed through Generative Productive Dialogue between [Human] and [System], with human verification of all factual claims.*

**Detailed (for high-stakes work):**
> *Process: Generative Productive Dialogue with Claude Sonnet 4 (47 exchanges, 3 hours). Human verified all citations, legal reasoning, and technical accuracy. Final content represents human judgment and accountability.*

### Ownership and Accountability

**Who owns GPD outputs?**
- Legally: Depends on jurisdiction, employment context, contractual agreements
- Ethically: Human who directed process and verified outputs
...
- Don't claim sole authorship where process was heavily GPD-driven
...
> *Methodology: Developed through Generative Productive Dialogue.*
...
Human Accountability: [Your Name] responsible for accuracy and content.
```
...
> *Methods: Analysis conducted through Generative Productive Dialogue with [System]. All citations independently verified. Statistical calculations checked using [independent tool]. Author maintains responsibility for all claims and conclusions.*
...
> *Prepared through Generative Productive Dialogue. All legal research independently verified. Case citations checked against [Legal Database]. This document represents the professional judgment and responsibility of [Attorney/Professional Name].*

---

## Styling Recommendations

* **Italics:** Creates a "meta-commentary" separation between process description and content.
...
No. Prompting implies one-directional command ("write me a blog post"). GPD emphasizes the iterative, coupled nature of the reasoning process—human reasoning shapes computational output, which shapes continued human reasoning, in cycles. The artifact emerges from the process itself, not from a single prompt-response pair.
...
**No—not without verification.** The computational system can hallucinate citations, fabricate statistics, generate plausible-sounding but incorrect information. GPD outputs require the same level of verification as information from any untrusted source. Your responsibility is verification, not blind trust.
...
**Differences:**
- Research assistant has accountability, can be trained, has judgment
- Computational system has none of these
...
Unknown. Currently in early adoption phase. Usage is widespread but terminology and norms are still forming. This framework is one proposal among many emerging approaches.
...
3. **It protects precision:** Neither overclaiming ("we collaborated") nor underclaiming ("AI helped me"). Just accurate description of a coupled reasoning process.

4. **It assigns responsibility clearly:** Human maintains accountability regardless of computational involvement.

5. **It acknowledges limitations:** Built-in recognition that system can fail, hallucinate, require verification.
...
**Added:**
- Acknowledgment of "dialogue" as functional metaphor with caveat
...
**Modified:**
- Clarified that human maintains final responsibility and verification
- Emphasized that system can produce confidently wrong outputs
- Added explicit language about computational structure limitations
- Made clear distinction between system capabilities and human responsibilities

---

*This document (v1.1) was developed through Generative Productive Dialogue—a process interfacing human and computational reasoning to generate artifacts. All claims about existing terminology were verified through literature search. Framework represents proposal for community consideration and refinement.*
