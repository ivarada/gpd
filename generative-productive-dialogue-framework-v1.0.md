...
- Coupled chains of thought (human + algorithmic)
- Two latent structures interfaced (biological + parametric)
...
|---------|-----------------|
| **Socratic Dialogue** | Socratic methods produce insight. GPD produces tangible artifacts. |
| **Tool Use** | Tools are passive. They do not contain latent structure you can probe. |
| **Collaboration** | Collaboration implies shared intention. AI has no intention. |
| **AI-Assisted Writing** | Implies the human writes and AI assists. GPD is more integrated. |
| **Prompting** | Implies one-directional command. GPD is iterative exchange. |
...
When we use GPD, we aren't outsourcing. We aren't cheating. We are interfacing—two reasoning processes coupled, producing.

---

## Citation Templates

Choose the template that fits the density of your document.

### Option 1: Standard (Clean & Minimal)

**Best for:** Professional emails, internal memos, slide decks.

> *Methodology: Developed through Generative Productive Dialogue.*

---

### Option 2: Definitional (Recommended)
...
**Best for:** Technical documentation, code readmes, complex reports.

```
Production Note:
Process: Generative Productive Dialogue (GPD)
Human Reasoning: [Your Name]
Computational Structure: [Model Name, e.g., Claude Opus 4.5]
...
1. **It solves the "agency" problem:** People hesitate to admit they use AI because it sounds passive. GPD frames the user as an active participant ("coupled chains of thought") rather than a passive recipient.

2. **It sounds descriptive, not magical:** Terms like "parametric," "latent structure," and "artifacts" treat this as the engineering workflow it is—not science fiction.

3. **It protects precision:** Neither overclaiming ("we collaborated") nor underclaiming ("AI helped me"). Just accurate.
...
│                    └───────────┘                                │
│                                                                 │
│    Direction, judgment,           Breadth, velocity,            │
│    continuity, intent             generation, no intent         │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
The exact term "Generative Productive Dialogue" does not appear in existing literature.
...
GPD as defined here—coupled chains of thought, generative capacity embedded, artifacts emerging from the process—is novel.
